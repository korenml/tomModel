...
void kEpsilonPANSLR<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kEpsilonPANSLR<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kEpsilonPANSLR<BasicTurbulenceModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicTurbulenceModel>
kEpsilonPANSLR<BasicTurbulenceModel>::kEpsilonPANSLR
(
...
template<class BasicTurbulenceModel>
bool kEpsilonPANSLR<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kEpsilonPANSLR<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
