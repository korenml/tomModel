...
tmp<volScalarField> zetaf0VarTL<BasicTurbulenceModel>::Ts() const
{
	...
	return max(k_/(epsilon_ + this->epsilonMin_), 6.0*sqrt(this->nu()/(epsilon_ + this->epsilonMin_)));
}


template<class BasicTurbulenceModel>
tmp<volScalarField> zetaf0VarTL<BasicTurbulenceModel>::Ls() const
{
	...
	return CL_*max(pow(k_, 1.5)/(epsilon_ + this->epsilonMin_), Ceta_*pow025(pow3(this->nu())/(epsilon_ + this->epsilonMin_)));
}


template<class BasicTurbulenceModel>
void zetaf0VarTL<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
zetaf0VarTL<BasicTurbulenceModel>::zetaf0VarTL
(
...
template<class BasicTurbulenceModel>
bool zetaf0VarTL<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void zetaf0VarTL<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
