...
void kEpsilonPANSdyn<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kEpsilonPANSdyn<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kEpsilonPANSdyn<BasicTurbulenceModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicTurbulenceModel>
kEpsilonPANSdyn<BasicTurbulenceModel>::kEpsilonPANSdyn
(
...
template<class BasicTurbulenceModel>
bool kEpsilonPANSdyn<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kEpsilonPANSdyn<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
