...
void kEpsilonPANSHR<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kEpsilonPANSHR<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kEpsilonPANSHR<BasicTurbulenceModel>::epsilonSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicTurbulenceModel>
kEpsilonPANSHR<BasicTurbulenceModel>::kEpsilonPANSHR
(
...
template<class BasicTurbulenceModel>
bool kEpsilonPANSHR<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kEpsilonPANSHR<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
//      - fvm::Sp(alpha()*rho()*epsilonU_()/kU_(), epsilonU_)
      - fvm::Sp((C1_+(fk_/fEpsilon_)*(C2_-C1_))*alpha()*rho()*epsilonU_()/kU_(), epsilonU_)
      + epsilonSource()
